...
- **entity-core grounding** — an optional local MCP server that prepends a persistent identity layer + RAG memories + a knowledge graph to every request (with a prompt-cache-aware static/dynamic split)

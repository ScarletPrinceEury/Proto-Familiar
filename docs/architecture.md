...
├── browser-lens.js          The cognition layer (spec §3) — PURE, no playwright: PageData → leveled, ref'd, token-capped snapshots (outline/actions/text/full) + code-computed delta verdicts. isProtectedField flags password/file/credential fields. Fixture-tested without a browser.

...
| Web search & read | Opt-in web access (`web_search` + `read_webpage`). Works out of the box (built-in keyless search) — off by default, just turn it on. Optionally point it at your own SearXNG. See [Web search setup](websearch-setup.md) |

...
| [Entity-Core](entity-core.md) | Identity layer, memory enrichment, and MCP bridge (retired — replaced by Phylactery; kept for historical reference) |
...
(roughly newest first): [Trackers (design)](trackers-design.md) ·
